...
public class ChickenSystemTest {
  ...
  void test_1() throws Exception {
    ...
    HtmlButton urlaubBelegenNavButton = page.getElementByName("urlaub-belegen-btn");
    ...
    urlaubsDatum.setValueAttribute("10.03.2022");
    ...
    HtmlPage startSeite = urlaubBelegenForm.getInputByName("urlaubsanmeldung_abschicken").click();
    HtmlTable urlaubsTabelle = startSeite.getElementByName("urlaub_table");
    HtmlTableCell urlaubsDatumZelle = urlaubsTabelle.getCellAt(1, 0);
    System.out.println(urlaubsDatumZelle);
    assertThat(urlaubsDatumZelle.toString()).contains("2022-03-10");
