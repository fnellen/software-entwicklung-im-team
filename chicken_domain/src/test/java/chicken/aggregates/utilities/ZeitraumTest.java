...
public class ZeitraumTest {
  ...
  void test_1(){
    Zeitraum zeitraum = Zeitraum.erstelleZeitraum(LocalDate.of(2022,3,9), LocalTime.of(9, 15), LocalTime.of(10, 30));
  ...
  void test_1a(){
    Zeitraum zeitraum = Zeitraum.erstelleZeitraum(LocalDate.of(2022,3,7), LocalTime.of(9, 15), LocalTime.of(10, 30));
    assertThat(zeitraum).isNotNull();
  }
  ...
  void test_1b(){
    Zeitraum zeitraum = Zeitraum.erstelleZeitraum(LocalDate.of(2022,3,25), LocalTime.of(9, 15), LocalTime.of(10, 30));
    assertThat(zeitraum).isNotNull();
  }
  ...
  void test_2a(){
    Zeitraum zeitraum = Zeitraum.erstelleZeitraum(LocalDate.of(2022,3,1), LocalTime.of(9, 15), LocalTime.of(10, 30));
  ...
  void test_2b(){
    Zeitraum zeitraum = Zeitraum.erstelleZeitraum(LocalDate.of(2022,3,30), LocalTime.of(9, 15), LocalTime.of(10, 30));
    assertThat(zeitraum).isNull();
  }
  ...
  void test_3(){
    Zeitraum zeitraum = Zeitraum.erstelleZeitraum(LocalDate.of(2022,3,9), LocalTime.of(9, 12), LocalTime.of(10, 30));
    assertThat(zeitraum).isNull();
  }
  ...
  void test_4(){
    Zeitraum zeitraum = Zeitraum.erstelleZeitraum(LocalDate.of(2022,3,9), LocalTime.of(14, 30), LocalTime.of(10, 30));
    assertThat(zeitraum).isNull();
  }
  ...
  void test_5(){
    Zeitraum zeitraum = Zeitraum.erstelleZeitraum(LocalDate.of(2022,3,12), LocalTime.of(9, 30), LocalTime.of(10, 30));
    assertThat(zeitraum).isNull();
  }
  ...
  @DisplayName("Ein Zeitraum soll nicht valide sein, wenn das angegebene Datum am Wochenende liegt.")
  void test_6(){
    Zeitraum zeitraum = Zeitraum.erstelleZeitraum(LocalDate.of(2022,3,13), LocalTime.of(9, 30), LocalTime.of(10, 30));
    assertThat(zeitraum).isNull();
  }
}
