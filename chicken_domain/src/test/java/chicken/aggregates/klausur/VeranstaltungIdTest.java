...
public class VeranstaltungIdTest {
  ...
  void test_1() throws IOException {
    ...
    VeranstaltungsId erstelle = VeranstaltungsId.erstelle(217419L, webClientMock);
  ...
  void test_2() throws IOException {
    ...
    when(htmlPageMock.getWebResponse()).thenReturn(webResponseMock);
    when(webClientMock.getPage(anyString())).thenReturn(htmlPageMock);
    VeranstaltungsId erstelle = VeranstaltungsId.erstelle(257419L, webClientMock);
  ...
  void test_3() throws IOException {
    ...
    when(htmlPageMock.getWebResponse()).thenReturn(webResponseMock);
    when(webClientMock.getPage(anyString())).thenReturn(htmlPageMock);
    VeranstaltungsId erstelle = VeranstaltungsId.erstelle(0L, webClientMock);
