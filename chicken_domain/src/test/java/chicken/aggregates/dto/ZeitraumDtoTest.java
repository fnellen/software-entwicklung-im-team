...
public class ZeitraumDtoTest {
  ...
  void test_1() {
    ZeitraumDto
        zeitraumDto = ZeitraumDto.erstelleZeitraum(LocalDate.of(2022, 3, 9), LocalTime.of(9, 15),
        LocalTime.of(10, 30));
  ...
  void test_1a() {
    ZeitraumDto
        zeitraumDto = ZeitraumDto.erstelleZeitraum(LocalDate.of(2022, 3, 7), LocalTime.of(9, 15),
        LocalTime.of(10, 30));
    assertThat(zeitraumDto).isNotNull();
  }
  ...
  void test_1b() {
    ZeitraumDto
        zeitraumDto = ZeitraumDto.erstelleZeitraum(LocalDate.of(2022, 3, 25), LocalTime.of(9, 15),
        LocalTime.of(10, 30));
    assertThat(zeitraumDto).isNotNull();
  }
  ...
  void test_2a() {
    ZeitraumDto
        zeitraumDto = ZeitraumDto.erstelleZeitraum(LocalDate.of(2022, 3, 1), LocalTime.of(9, 15),
        LocalTime.of(10, 30));
  ...
  void test_2b() {
    ZeitraumDto
        zeitraumDto = ZeitraumDto.erstelleZeitraum(LocalDate.of(2022, 3, 30), LocalTime.of(9, 15),
        LocalTime.of(10, 30));
    assertThat(zeitraumDto).isNull();
  }
  ...
  void test_3() {
    ZeitraumDto
        zeitraumDto = ZeitraumDto.erstelleZeitraum(LocalDate.of(2022, 3, 9), LocalTime.of(9, 12),
        LocalTime.of(10, 30));
    assertThat(zeitraumDto).isNull();
  }
  ...
  void test_4() {
    ZeitraumDto
        zeitraumDto = ZeitraumDto.erstelleZeitraum(LocalDate.of(2022, 3, 9), LocalTime.of(14, 30),
        LocalTime.of(10, 30));
    assertThat(zeitraumDto).isNull();
  }
  ...
  void test_5() {
    ZeitraumDto
        zeitraumDto = ZeitraumDto.erstelleZeitraum(LocalDate.of(2022, 3, 12), LocalTime.of(9, 30),
        LocalTime.of(10, 30));
    assertThat(zeitraumDto).isNull();
  }
  ...
  void test_6() {
    ZeitraumDto
        zeitraumDto = ZeitraumDto.erstelleZeitraum(LocalDate.of(2022, 3, 13), LocalTime.of(9, 30),
        LocalTime.of(10, 30));
    assertThat(zeitraumDto).isNull();
  }
  ...
  void test_7() {
    ZeitraumDto
        zeitraumDto = ZeitraumDto.erstelleZeitraum(LocalDate.of(2022, 3, 7), LocalTime.of(9, 30),
        LocalTime.of(10, 30));
